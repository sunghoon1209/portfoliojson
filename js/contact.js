...
let currentPage = document.querySelector('.header__nav__pc ul li:nth-child(4) a');
...
// 반응형에서 해당 상위 작업
let currentPageMobile = document.querySelector('.header__nav-list ul li:nth-child(4) a');
